...
{
translate([9.600000,-7.000000,1.200000])rotate([0,0,-90.000000])m1(part,hole,block,casetop); // Q2 (back)
};
...
{
translate([-1.000000,-0.500000,1.200000])rotate([0,0,90.000000])m2(part,hole,block,casetop); // U4 (back)
};
...
{
translate([11.700001,15.300000,1.200000])rotate([0,0,90.000000])m1(part,hole,block,casetop); // Q2 (back)
};
...
{
translate([10.550000,-4.000000,1.200000])m6(part,hole,block,casetop); // D5 (back)
};
module part_D2(part=true,hole=false,block=false)
{
translate([11.400001,8.300000,1.200000])rotate([0,0,180.000000])m6(part,hole,block,casetop); // D5 (back)
};
...
{
translate([-9.200000,10.525001,1.200000])rotate([0,0,-90.000000])m7(part,hole,block,casetop); // D6 (back)
};
module part_J10(part=true,hole=false,block=false)
{
translate([-8.200000,-13.700000,1.200000])rotate([0,0,90.000000])m8(part,hole,block,casetop,02); // J10 (back)
};
...
{
translate([3.800000,-12.799999,1.200000])rotate([0,0,-90.000000])m9(part,hole,block,casetop); // U1 (back)
};
module part_J1(part=true,hole=false,block=false)
{
translate([0.000000,9.800000,1.200000])rotate([0,0,180.000000])m10(part,hole,block,casetop); // J1 (back)
};
module part_D3(part=true,hole=false,block=false)
{
translate([11.400001,12.300000,1.200000])rotate([0,0,180.000000])m6(part,hole,block,casetop); // D5 (back)
};
...
{
translate([9.600000,1.700001,1.200000])m11(part,hole,block,casetop); // Q3 (back)
};
...
{
translate([-12.000000,16.500000,1.200000])rotate([0,0,90.000000])m12(part,hole,block,casetop); // D4 (back)
};
...
{
translate([11.400001,10.300000,1.200000])rotate([0,0,180.000000])m6(part,hole,block,casetop); // D5 (back)
};

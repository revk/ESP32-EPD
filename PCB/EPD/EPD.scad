...
{
translate([9.000000,-7.500000,1.200000])rotate([0,0,-10.000000])m3(part,hole,block,casetop); // D6 (back)
};
...
{
translate([11.700001,15.300000,1.200000])rotate([0,0,90.000000])m5(part,hole,block,casetop); // Q1 (back)
};
...
{
translate([-10.549999,-10.632499,1.200000])m6(part,hole,block,casetop,2); // J4 (back)
};
module part_J6(part=true,hole=false,block=false)
{
translate([-3.799999,-10.632499,1.200000])m6(part,hole,block,casetop,2); // J4 (back)
};
...
{
translate([11.400001,8.300000,1.200000])rotate([0,0,180.000000])m3(part,hole,block,casetop); // D6 (back)
};
...
{
translate([2.950001,-10.632499,1.200000])m6(part,hole,block,casetop,2); // J4 (back)
};
...
{
translate([-0.900000,-9.900000,1.200000])rotate([0,0,180.000000])m9(part,hole,block,casetop); // D5 (back)
};
...
{
translate([11.400001,12.300000,1.200000])rotate([0,0,180.000000])m3(part,hole,block,casetop); // D6 (back)
};
...
{
translate([11.400001,10.300000,1.200000])rotate([0,0,180.000000])m3(part,hole,block,casetop); // D6 (back)
};
module part_D7(part=true,hole=false,block=false)
{
translate([-7.700000,-9.900000,1.200000])rotate([0,0,180.000000])m9(part,hole,block,casetop); // D5 (back)
};
